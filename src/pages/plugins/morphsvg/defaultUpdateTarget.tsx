...
type MorphSVGStatic = { defaultUpdateTarget?: unknown };

const MorphDefaultUpdateTarget = () => {
  ...
  const read = () => setVal(getM()?.defaultUpdateTarget ?? null);
...
export default MorphDefaultUpdateTarget;
