...
type DraggableInstance = { startY?: number; kill?: () => void };
...
const StartYProp = () => {
  ...
  const read = () => setVal(Number(instRef.current?.startY ?? 0));
  ...
  return (
    <DocumentationLayout>
      <section className="space-y-6 pt-10">
        ...
        <div className="text-sm">startY: {val.toFixed(0)}</div>
