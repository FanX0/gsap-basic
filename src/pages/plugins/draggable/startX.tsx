...
type DraggableInstance = { startX?: number; kill?: () => void };
...
const StartXProp = () => {
  ...
  const read = () => setVal(Number(instRef.current?.startX ?? 0));
  ...
  return (
    <DocumentationLayout>
      <section className="space-y-6 pt-10">
        ...
        <div className="text-sm">startX: {val.toFixed(0)}</div>
