...
type DraggableInstance = { isPressed?: boolean; kill?: () => void };
...
const IsPressedProp = () => {
  ...
  const read = () => setVal(Boolean(instRef.current?.isPressed));
  ...
  return (
    <DocumentationLayout>
      <section className="space-y-6 pt-10">
        ...
        <div className="text-sm">isPressed: {String(val)}</div>
