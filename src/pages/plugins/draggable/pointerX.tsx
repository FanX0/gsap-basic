...
type DraggableInstance = { pointerX?: number; kill?: () => void };
...
const PointerXProp = () => {
  ...
  const read = () => setVal(Number(instRef.current?.pointerX ?? 0));
  ...
  return (
    <DocumentationLayout>
      <section className="space-y-6 pt-10">
        ...
        <div className="text-sm">pointerX: {val.toFixed(0)}</div>
