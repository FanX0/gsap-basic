...
type DraggableInstance = { pointerY?: number; kill?: () => void };
...
const PointerYProp = () => {
  ...
  const read = () => setVal(Number(instRef.current?.pointerY ?? 0));
  ...
  return (
    <DocumentationLayout>
      <section className="space-y-6 pt-10">
        ...
        <div className="text-sm">pointerY: {val.toFixed(0)}</div>
