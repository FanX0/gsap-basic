...
type DraggableInstance = { deltaX?: number; kill?: () => void };
...
const DeltaXProp = () => {
  ...
  const read = () => setVal(Number(instRef.current?.deltaX ?? 0));
  ...
  return (
    <DocumentationLayout>
      <section className="space-y-6 pt-10">
        ...
        <div className="text-sm">deltaX: {val.toFixed(0)}</div>
