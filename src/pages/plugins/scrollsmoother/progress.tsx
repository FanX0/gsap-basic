...
const Progress = () => {
  ...
  type Smoother = {
    ...
    effects?: (selector: string, config: unknown | false) => void;
    getVelocity?: () => number;
    kill?: () => void;
    offset?: (el: Element | null) => number;
    paused?: (value?: boolean) => boolean;
    scrollTo?: (target: number | Element | string) => void;
  ...
  const read = () => setProgress(Number(smootherRef.current?.progress ?? 0));
